      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: ListView(
              children: [
                buildTitleRow("Kelas Hari Ini", 3),
                SizedBox(
                  height: 20,
                ),
                buildClassItem(),
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      buildTaskItem(3, "Matematika", Colors.red),
                      buildTaskItem(
                          3, "Bahasa Indonesia: Kerjakan...", Colors.green),
                      buildTaskItem(
                          3, "Bahasa Indonesia: Ringkas...", Colors.green),
                      buildTaskItem(
                          5, "Ipa: Kerjakan Latihan 1..", Colors.blue),
                    ],
                  ),
                )
              ],
